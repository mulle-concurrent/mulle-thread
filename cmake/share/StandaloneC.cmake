if( NOT __STANDALONE_C_CMAKE__)
   ...
   if( STANDALONE)
      ...
      if( NOT STANDALONE_NAME)
         set( STANDALONE_NAME "mulle-thread-standalone")
      endif()
      set( STANDALONE_DEFINITIONS ${MULLE_THREAD_DEFINITIONS})
...
mulle-thread-standalone.c with contents like this to it:
   int  ___mulle_thread_unused__;
and everybody will be happy")
         ...
         add_dependencies( ${STANDALONE_NAME} mulle-thread)
         if( STARTUP_NAME)
